 ...
 *
 * Compile from the project root (Unix):
 *   c++ -std=c++17 -shared -fPIC -Icpp/include resources/scripts/main.cpp -o resources/scripts/libscript.so
 * Compile from the project root (Windows):
 *   cl /LD /Icpp\include resources\scripts\main.cpp /Fe:resources\scripts\script.dll
 */
#include "../../cpp/include/teleology.h"
#include <cstdint>
#include <cstdio>
